...
console.log("The longest city name is " + longestCity);
console.log("It has " + longestCity.length + " characters");
console.log("Its first letter is " + longestCity.substring(0,1));
