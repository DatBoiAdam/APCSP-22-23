...
function findIcon(iconName){
  //returning icon using its index value
    if (iconName=="Rock") {
      return (icons[0]);
...
function randomChoose(list){
  //picks a random valid index number for the list
...
function decideWinner(playerChoice, computerChoice){
  //tests all possible conditions for a draw or human win, if none are found cpu wins.
